...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Configuracion.blog_rss2'
        db.add_column('configuracion_configuracion', 'blog_rss2',
                      self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Configuracion.blog_rss2'
        db.delete_column('configuracion_configuracion', 'blog_rss2')
