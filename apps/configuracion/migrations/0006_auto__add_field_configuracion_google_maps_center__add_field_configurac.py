...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Configuracion.google_maps_center'
        db.add_column('configuracion_configuracion', 'google_maps_center',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Configuracion.google_maps_zoom'
        db.add_column('configuracion_configuracion', 'google_maps_zoom',
    ...
    models = {
        'configuracion.configuracion': {
            ...
            'blog_rss2': ('django.db.models.fields.URLField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'}),
            ...
            'google_maps_center': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
