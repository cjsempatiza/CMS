...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'PrecioPagina'
        db.create_table('web_preciopagina', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('pagina', self.gf('django.db.models.fields.related.ForeignKey')(related_name='precios', to=orm['web.Pagina'])),
            ('orden', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('detalle', self.gf('django.db.models.fields.CharField')(unique=True, max_length=80)),
            ('precio', self.gf('django.db.models.fields.FloatField')(default=0)),
        ))
        db.send_create_signal('web', ['PrecioPagina'])

    def backwards(self, orm):
        # Deleting model 'PrecioPagina'
        db.delete_table('web_preciopagina')
    ...
    models = {
        ...
        'web.imagenpagina': {
            ...
            'descripcion': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'es_cabecera': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'web.preciopagina': {
            'Meta': {'ordering': "['orden']", 'object_name': 'PrecioPagina'},
            'detalle': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '80'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'orden': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'pagina': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'precios'", 'to': "orm['web.Pagina']"}),
