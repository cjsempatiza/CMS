...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ImagenPagina.es_cabecera'
        db.add_column('web_imagenpagina', 'es_cabecera',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Pagina.en_portada'
        db.add_column('web_pagina', 'en_portada',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'ImagenPagina.es_cabecera'
        db.delete_column('web_imagenpagina', 'es_cabecera')

        # Deleting field 'Pagina.en_portada'
        db.delete_column('web_pagina', 'en_portada')
