...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Testimonios.categoria'
        db.delete_column('testimonios_testimonios', 'categoria_id')

    def backwards(self, orm):
        # Adding field 'Testimonios.categoria'
        db.add_column('testimonios_testimonios', 'categoria',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['catalog.Category'], blank=True),
                      keep_default=False)
