...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'TestimoniosConfig.titulo_lat'
        db.delete_column('testimonios_testimoniosconfig', 'titulo_lat')
    ...
    def backwards(self, orm):
        ...
        raise RuntimeError("Cannot reverse this migration. 'TestimoniosConfig.titulo_lat' and its values cannot be restored.")
        # Adding field 'TestimoniosConfig.texto_lat'
